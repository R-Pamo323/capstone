                ...
                @foreach ($transferencia as $item)
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p> <a href="{{ route('detailstransferencia', $item->id) }}" class="btn btn-outline-info btn-lg">Detalles</a>   <a class="btn btn-outline-warning btn-lg">Editar</a>   <a class="btn btn-outline-danger btn-lg">Eliminar</a> </p>
                        </div>
                    </div>
                @endforeach
            </div>
